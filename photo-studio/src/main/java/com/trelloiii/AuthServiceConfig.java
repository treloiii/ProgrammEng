...
public class AuthServiceConfig extends AuthorizationServerConfigurerAdapter {
    private static final String CLIENT_ID = "photo-store";
    private static final String CLIENT_SECRET = "$2y$12$HAdYr79NpvVWZp8SKRJpsOmD0ajuViLeDNvWca.KXgdmZus6cbD.C";//secret
